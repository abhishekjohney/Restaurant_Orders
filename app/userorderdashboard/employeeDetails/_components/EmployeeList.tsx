              ...
              <div className="p-4">
                ...
                <p
                  className={`py-2 px-4 text-lg font-bold mb-2 text-white ${
                    listItem?.AttType1 === "P" ? "bg-green-500" : listItem?.AttType1 === "Ab" ? "bg-red-500" : ""
                  }`}
                >
                  {listItem?.AttType1}
                </p>
                ...
                <p className={`py-2 px-4 text-white ${listItem?.BalAmt > 0 ? "bg-green-500" : "bg-red-500"}`}>
              ...
              {attnList &&
                attnList.slice(1).map((listItem, index) => (
                  <tr key={index}>
                    ...
                    <td className={`py-2 px-4 text-white ${listItem?.BalAmt > 0 ? "bg-green-500" : "bg-red-500"}`}>{listItem?.BalAmt}</td>
