...
export const UpdateB2BOrders = async (ReqJSonData: string, ReqJSonData2: string, ReqAcaStart: string, ReqUpdateType: string) => {
  try {
...
export const GetInvoiceFromOrderByCode = async (ReqOrderID: number, ReqOrderDate: string, ReqAcaStart: string) => {
  try {
