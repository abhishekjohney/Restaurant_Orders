...
import EmployeeAttnList from "@/components/Admin/EmployeeAttnList";
import BackButton from "@/components/BackButton";
import { Spinner } from "@/components/Spinner";
import CustomModal from "@/components/Modal";
import AttendanceModal from "@/components/common/attendance";
...
const EmployeeDetails = () => {
    ...
    useEffect(() => {
        ...
        fetchData();
    }, [session.data?.user.name, DateVal]);
                ...
                <div className="flex justify-center items-center">
                    <div className="w-full mt-2">
                        ...
                        <div className="flex gap-2 items-center">
                            ...
                            />
                            <button className="px-3 py-2 md:px-4 md:py-3 md:w-64 font-semibold rounded-md btn btn-primary">
                                Search
                            </button>
                        </div>
                        ...
                        <div className="flex md:flex-row flex-col ">
                                    ...
                                    listToRender.map((EmpList, index) => (
                                        ...
                                        >
                                            <div className="p-4 flex items-center justify-between text-center">
                                                <div>
                                                    <p className="text-gray-700 flex text-lg  font-medium  mb-2">
                                            ...
                                            <h4 className=" text-xl text-center font-extrabold my-1">
                                                {EmpList.EmployeeName}
                                            </h4>
                                            <div className="p-3">
                                                <div
                                                    className={`p-1 text-center whitespace-nowrap text-white ${
                                                        EmpList.BalAmt < 0 ? "bg-error" : "bg-success"
                                                    }`}
                                                >
                                                    <p className="text-white text-lg font-bold">
                                                        Balance Amount: {EmpList.BalAmt}
                                                    </p>
                                                </div>
                          ...
                          Select
                            ...
                            <input
                              type="radio"
                              checked={selectedItem === EmpList.EMPAUTOID}
                              onChange={() => handleRowSelect(EmpList)}
                            />
                          </td> */}
                                                    ...
                                                    <td
                                                        className={`py-4 px-6 whitespace-nowrap text-white ${
                                                            EmpList.BalAmt <= 0 ? "bg-error" : "bg-success"
                                                        }`}
                                                    >
                                                        {EmpList.BalAmt}
                    ...
                    <div className="bg-gray-100  customScrolling relative bottom-3 -mt-5 customHeightModal shadow-md shadow-gray-400 p-8 rounded-lg text-center">
                        ...
                        <div className="w-full mb-4">
                            <div className="flex flex-wrap mb-3">
                                <label className="text-white  px-2 py-2 bg-info rounded-md mr-2 lg:mb-0 mb-2">
                                    EmpCode:
                                </label>
                                <input
                                    type="text"
                                ...
                                />
                                <label
                                    className={`text-white px-2 py-2 rounded-md mt-2 lg:mt-0 mr-2 ${
                                        formData?.DRPYN ? "bg-error" : "bg-success"
                                    }`}
                                >
                            ...
                            <div className="flex flex-wrap">
                                ...
                                <button
                                    className="border rounded-md shadow-md w-full lg:w-40 py-2 px-4 btn btn-primary"
