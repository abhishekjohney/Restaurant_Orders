...
function OrganizationMasterSetting() {
  ...
  return (
    <>
      <div className="lg:flex mt-1">
        ...
        <div className="w-full lg:order-first md:mt-2 overflow-y-auto ">
          <div className="lg:flex">
            <div className="w-full pl-4">
              <div className="lg:flex items-center mt-2">
                <div className="flex flex-wrap items-center">
                  <label className="text-gray-600 mr-2 mt-2">
                    Sticker Per Row:
                  </label>
                  <input
                    type="text"
                    className="rounded-md input-primary shadow-md py-2 pl-2 w-24 mr-2 mt-2"
                    value={formData?.STKRPERRW as number}
                    onChange={(e) =>
                      setFormData((prevData) => ({
                        ...(prevData as EmpMstrType),
                        STKRPERRW: e.target.value,
                      }))
                    }
                  />
                </div>
                <div className="flex flex-wrap items-center mt-2">
                  ...
                  >
                    Generate Bill No According to Selected Mode of Pay
                  </label>
                </div>
              </div>
              <div className="md:flex items-center mt-2">
                <label className="text-gray-600 mr-2">DrawerOpen:</label>
                <input
                  type="text"
                  className="rounded-md input-primary shadow-md py-2 pl-2  w-full"
                  value={formData?.DRWOPNCOM as string}
                  onChange={(e) =>
                    setFormData((prevData) => ({
                      ...(prevData as EmpMstrType),
                      DRWOPNCOM: e.target.value,
                    }))
                  }
                />
              </div>
              ...
              <div className="md:flex items-center mt-2">
                <label className="text-gray-600 mr-2">DisplayPort:</label>
                <input
                  type="text"
                  className="rounded-md input-primary shadow-md py-2 pl-2  w-full"
                  value={formData?.PDPORT as number}
                  onChange={(e) =>
                    setFormData((prevData) => ({
                      ...(prevData as EmpMstrType),
                      PDPORT: e.target.value,
                    }))
                  }
                />
              </div>
              <div className="md:flex items-center mt-2">
                <label className="text-gray-600 mr-2">PrintPort:</label>
                <input
                  type="text"
                  className="rounded-md input-primary shadow-md py-2 pl-2  w-full"
                  value={formData?.PRTPORT as string}
                  onChange={(e) =>
                    setFormData((prevData) => ({
                      ...(prevData as EmpMstrType),
                      PRTPORT: e.target.value,
                    }))
                  }
                />
              </div>
              <div className="md:flex items-center mt-2">
                <label className="text-gray-600 mr-2">PLUCodePrefix:</label>
                <input
                  type="text"
                  className="rounded-md input-primary shadow-md py-2 pl-2  w-full"
                  value={formData?.PLUCODEPRX as string}
                  onChange={(e) =>
                    setFormData((prevData) => ({
                      ...(prevData as EmpMstrType),
                      PLUCODEPRX: e.target.value,
                    }))
                  }
                />
              </div>
              <div className="md:flex items-center mt-2">
                <label className="text-gray-600 mr-2">BarCodeLabel:</label>
                <input
                  type="text"
                  className="rounded-md input-primary shadow-md py-2 pl-2  w-full"
                  value={formData?.BarCodeLabelType as number}
                  onChange={(e) =>
                    setFormData((prevData) => ({
                      ...(prevData as EmpMstrType),
                      BarCodeLabelType: e.target.value,
                    }))
                  }
                />
              </div>
              <div className="md:flex items-center mt-2">
                <label className="text-gray-600 mr-2">BackupPath:</label>
                <input
                  type="text"
                  className="rounded-md input-primary shadow-md py-2 pl-2  w-full"
                  value={formData?.TCOMPANY as string}
                  onChange={(e) =>
                    setFormData((prevData) => ({
                      ...(prevData as EmpMstrType),
...
export default OrganizationMasterSetting;
